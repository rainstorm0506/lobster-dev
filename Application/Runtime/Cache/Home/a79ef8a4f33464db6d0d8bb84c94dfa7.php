...
<div class="main">
    <?php if(count($rows) != 0): if(is_array($rows)): $i = 0; $__LIST__ = $rows;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><div class="con fl con1" style="margin-top:30px;">
                <h1>查询结果</h1>
        ...
        <?php else: ?><div class="con fl con1" style="margin-top:30px;margin-left: -45px"><h2>没有该订单的消息</h2></div><?php endif; ?>          
</div>
<div class="footer">
	<div class="bot">
