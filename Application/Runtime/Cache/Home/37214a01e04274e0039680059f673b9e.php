...
<div class="main">
	<div class="tit f20 bold fl">阿丽小龙虾</div>
    <div class="con fl">
    	<dl class="de">
        	<dt><img src="<?php echo ($row["goods_big_img"]); ?>" width="238" height="149"></dt>
            <dd>
            	<p class="f18"><?php echo ($row["name"]); ?><span class="red">（<?php echo ($row["goods_price"]); ?>）</span></p>
                <p>供应时间：<?php echo ($row["supply_time"]); ?></p>
                <p>供应日期：<?php echo ($row["supply_data"]); ?></p>
                <p>供应地区：<?php echo ($row["supply_area"]); ?></p>
                <p><a class="gm f14" href="<?php echo U('Orders/dinner',array('id'=>$row['id']));?>">开始购买</a></p>
            </dd>
        </dl>
    </div>
...
<div class="con fl">
    <ul class="pro">
      <?php if(is_array($rows)): $i = 0; $__LIST__ = $rows;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><li>
            <a class="jg fl" href="javascript:void(0)">
